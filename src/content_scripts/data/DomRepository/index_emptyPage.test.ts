  ...
  describe("whole tests", () => {
    ...
    it("getElmOfSrcCode", () => {
      ...
      expect(() => {
        ...
        '"Unexpected DOM. Probably GitHub has been updated. Please contact the developer or wait until the extension is fixed. selector1: \\"#repo-content-turbo-frame div.Box-body table.swagger-viewer--original_src_area\\", selector2: \\"#repo-content-pjax-container div.Box-body table.swagger-viewer--original_src_area, selector3: \\"#repo-content-turbo-frame section[aria-labelledby=\\"file-name-id\\"].swagger-viewer--original_src_area\\""'
      )
    })
