...
import { html as swagger31YamlHtml } from "./fixtures/GitHubPageHtml_2023_swagger_3_1_yaml"

/**
 * Use 1 mock per file because it is not possible to reset the mocks in the same file.
 */
describe("GitHubPageHtml new codeview(2023) with swagger 3.1 yaml tests", () => {
  beforeAll(() => {
    // ## Arrange ##
